...
#define SBK_QTWEBKIT_QLIST_QACTIONPTR_IDX                            4 // QList<QAction * >
#define SBK_QTWEBKIT_QLIST_QOBJECTPTR_IDX                            5 // const QList<QObject * > &
#define SBK_QTWEBKIT_QLIST_QBYTEARRAY_IDX                            6 // QList<QByteArray >
#define SBK_QTWEBKIT_QLIST_QWEBPLUGINFACTORY_PLUGIN_IDX              7 // QList<QWebPluginFactory::Plugin >
#define SBK_QTWEBKIT_QLIST_QWEBPLUGINFACTORY_MIMETYPE_IDX            8 // QList<QWebPluginFactory::MimeType >

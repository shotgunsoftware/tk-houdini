...
#define SBK_PHONON_QHASH_QBYTEARRAY_QVARIANT_IDX                     5 // const QHash<QByteArray, QVariant > &
...
#define SBK_PHONON_QLIST_QVARIANT_IDX                                11 // const QList<QVariant > &
#define SBK_PHONON_QLIST_QACTIONPTR_IDX                              12 // QList<QAction * >
#define SBK_PHONON_QLIST_PHONON_AUDIOCHANNELDESCRIPTION_IDX          13 // QList<Phonon::AudioChannelDescription >
#define SBK_PHONON_QLIST_PHONON_SUBTITLEDESCRIPTION_IDX              14 // QList<Phonon::SubtitleDescription >
#define SBK_PHONON_QLIST_PHONON_PATH_IDX                             15 // QList<Phonon::Path >
#define SBK_PHONON_QPAIR_QBYTEARRAY_QSTRING_IDX                      16 // QPair<QByteArray, QString >
#define SBK_PHONON_QLIST_QPAIR_QBYTEARRAY_QSTRING_IDX                17 // QList<QPair<QByteArray, QString > >
#define SBK_PHONON_QLIST_PHONON_EFFECTPTR_IDX                        18 // QList<Phonon::Effect * >
#define SBK_PHONON_QSET_QOBJECTPTR_IDX                               19 // QSet<QObject * >
#define SBK_PHONON_QLIST_PHONON_EFFECTPARAMETER_IDX                  20 // QList<Phonon::EffectParameter >
#define SBK_PHONON_QLIST_PHONON_MEDIASOURCE_IDX                      21 // const QList<Phonon::MediaSource > &
#define SBK_PHONON_QLIST_QURL_IDX                                    22 // const QList<QUrl > &
#define SBK_PHONON_QMULTIMAP_QSTRING_QSTRING_IDX                     23 // QMultiMap<QString, QString >

...
#define SBK_QTCORE_QVECTOR_QXMLSTREAMATTRIBUTE_IDX                   12 // QVector<QXmlStreamAttribute > &
#define SBK_QTCORE_QLIST_QXMLSTREAMATTRIBUTE_IDX                     13 // const QList<QXmlStreamAttribute > &
...
#define SBK_QTCORE_QMAP_INT_QVARIANT_IDX                             22 // QMap<int, QVariant >
#define SBK_QTCORE_QHASH_INT_QBYTEARRAY_IDX                          23 // const QHash<int, QByteArray > &
#define SBK_QTCORE_QPAIR_QREAL_QVARIANT_IDX                          24 // QPair<qreal, QVariant >
#define SBK_QTCORE_QVECTOR_QPAIR_QREAL_QVARIANT_IDX                  25 // QVector<QPair<qreal, QVariant > >
#define SBK_QTCORE_QPAIR_INT_INT_IDX                                 26 // QPair<int, int >
#define SBK_QTCORE_QLIST_QPAIR_INT_INT_IDX                           27 // QList<QPair<int, int > >
#define SBK_QTCORE_QLIST_QABSTRACTTRANSITIONPTR_IDX                  28 // QList<QAbstractTransition * >
#define SBK_QTCORE_QSET_QABSTRACTSTATEPTR_IDX                        29 // QSet<QAbstractState * >
#define SBK_QTCORE_QLIST_QABSTRACTANIMATIONPTR_IDX                   30 // QList<QAbstractAnimation * >
#define SBK_QTCORE_QLIST_QVARIANT_IDX                                31 // const QList<QVariant > &
#define SBK_QTCORE_QLIST_QABSTRACTSTATEPTR_IDX                       32 // const QList<QAbstractState * > &

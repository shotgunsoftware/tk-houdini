...
#define SBK_QTGUI_QLIST_QPRINTERINFO_IDX                             1 // QList<QPrinterInfo >
#define SBK_QTGUI_QLIST_QPRINTER_PAGESIZE_IDX                        2 // QList<QPrinter::PageSize >
...
#define SBK_QTGUI_QLIST_QREAL_IDX                                    7 // QList<qreal >
#define SBK_QTGUI_QVECTOR_QREAL_IDX                                  8 // QVector<qreal >
#define SBK_QTGUI_QLIST_QTREEWIDGETITEMPTR_IDX                       9 // const QList<QTreeWidgetItem * > &
#define SBK_QTGUI_QLIST_QSTANDARDITEMPTR_IDX                         10 // const QList<QStandardItem * > &
#define SBK_QTGUI_QLIST_INT_IDX                                      11 // QList<int >
#define SBK_QTGUI_QLIST_QFONTDATABASE_WRITINGSYSTEM_IDX              12 // QList<QFontDatabase::WritingSystem >
#define SBK_QTGUI_QLIST_QITEMSELECTIONRANGE_IDX                      13 // const QList<QItemSelectionRange > &
#define SBK_QTGUI_QSET_QITEMSELECTIONRANGE_IDX                       14 // const QSet<QItemSelectionRange > &
#define SBK_QTGUI_QVECTOR_QITEMSELECTIONRANGE_IDX                    15 // const QVector<QItemSelectionRange > &
#define SBK_QTGUI_QLIST_QKEYSEQUENCE_IDX                             16 // QList<QKeySequence >
...
#define SBK_QTGUI_QLIST_QOBJECTPTR_IDX                               21 // const QList<QObject * > &
#define SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                           22 // const QHash<int, QByteArray > &
#define SBK_QTGUI_QLIST_QPRINTER_PAPERSOURCE_IDX                     23 // QList<QPrinter::PaperSource >
#define SBK_QTGUI_QLIST_QWIDGETPTR_IDX                               24 // QList<QWidget * >
#define SBK_QTGUI_QLIST_QPOLYGONF_IDX                                25 // QList<QPolygonF >
#define SBK_QTGUI_QVECTOR_QPOINTF_IDX                                26 // const QVector<QPointF > &
#define SBK_QTGUI_QLIST_QPOINTF_IDX                                  27 // const QList<QPointF > &
#define SBK_QTGUI_QLIST_QGESTUREPTR_IDX                              28 // const QList<QGesture * > &
#define SBK_QTGUI_QLIST_QINPUTMETHODEVENT_ATTRIBUTE_IDX              29 // const QList<QInputMethodEvent::Attribute > &
#define SBK_QTGUI_QLIST_QTOUCHEVENT_TOUCHPOINT_IDX                   30 // const QList<QTouchEvent::TouchPoint > &
#define SBK_QTGUI_QLIST_QABSTRACTANIMATIONPTR_IDX                    31 // QList<QAbstractAnimation * >
#define SBK_QTGUI_QLIST_QABSTRACTSTATEPTR_IDX                        32 // const QList<QAbstractState * > &
#define SBK_QTGUI_QLIST_QTEXTLAYOUT_FORMATRANGE_IDX                  33 // QList<QTextLayout::FormatRange >
#define SBK_QTGUI_QVECTOR_QTEXTLAYOUT_FORMATRANGE_IDX                34 // const QVector<QTextLayout::FormatRange > &
#define SBK_QTGUI_QVECTOR_UNSIGNEDINT_IDX                            35 // QVector<unsigned int >
#define SBK_QTGUI_QLIST_QSIZE_IDX                                    36 // QList<QSize >
#define SBK_QTGUI_QLIST_QGRAPHICSITEMPTR_IDX                         37 // QList<QGraphicsItem * >
#define SBK_QTGUI_QLIST_QGRAPHICSTRANSFORMPTR_IDX                    38 // const QList<QGraphicsTransform * > &
#define SBK_QTGUI_QVECTOR_QLINE_IDX                                  39 // const QVector<QLine > &
#define SBK_QTGUI_QVECTOR_QLINEF_IDX                                 40 // const QVector<QLineF > &
#define SBK_QTGUI_QVECTOR_QRECT_IDX                                  41 // const QVector<QRect > &
#define SBK_QTGUI_QVECTOR_QRECTF_IDX                                 42 // const QVector<QRectF > &
#define SBK_QTGUI_QLIST_QABSTRACTBUTTONPTR_IDX                       43 // QList<QAbstractButton * >
#define SBK_QTGUI_QLIST_QACTIONPTR_IDX                               44 // QList<QAction * >
#define SBK_QTGUI_QLIST_QGRAPHICSWIDGETPTR_IDX                       45 // QList<QGraphicsWidget * >
#define SBK_QTGUI_QLIST_QUNDOSTACKPTR_IDX                            46 // QList<QUndoStack * >
#define SBK_QTGUI_QLIST_QRECTF_IDX                                   47 // const QList<QRectF > &
#define SBK_QTGUI_QLIST_QGRAPHICSVIEWPTR_IDX                         48 // QList<QGraphicsView * >
#define SBK_QTGUI_QLIST_QTEXTBLOCK_IDX                               49 // QList<QTextBlock >
#define SBK_QTGUI_QLIST_QTEXTFRAMEPTR_IDX                            50 // QList<QTextFrame * >
#define SBK_QTGUI_QPAIR_QREAL_QPOINTF_IDX                            51 // QPair<qreal, QPointF >
#define SBK_QTGUI_QLIST_QPAIR_QREAL_QPOINTF_IDX                      52 // QList<QPair<qreal, QPointF > >
#define SBK_QTGUI_QPAIR_QREAL_QREAL_IDX                              53 // QPair<qreal, qreal >
#define SBK_QTGUI_QLIST_QPAIR_QREAL_QREAL_IDX                        54 // QList<QPair<qreal, qreal > >
#define SBK_QTGUI_QLIST_QDOCKWIDGETPTR_IDX                           55 // QList<QDockWidget * >
#define SBK_QTGUI_QLIST_QURL_IDX                                     56 // const QList<QUrl > &
#define SBK_QTGUI_QMAP_QDATE_QTEXTCHARFORMAT_IDX                     57 // QMap<QDate, QTextCharFormat >
#define SBK_QTGUI_QLIST_QWIZARD_WIZARDBUTTON_IDX                     58 // const QList<QWizard::WizardButton > &
#define SBK_QTGUI_QLIST_QTEXTEDIT_EXTRASELECTION_IDX                 59 // QList<QTextEdit::ExtraSelection >
#define SBK_QTGUI_QLIST_QMDISUBWINDOWPTR_IDX                         60 // QList<QMdiSubWindow * >
#define SBK_QTGUI_QLIST_QLISTWIDGETITEMPTR_IDX                       61 // QList<QListWidgetItem * >
#define SBK_QTGUI_QLIST_QTABLEWIDGETITEMPTR_IDX                      62 // QList<QTableWidgetItem * >
#define SBK_QTGUI_QLIST_QTABLEWIDGETSELECTIONRANGE_IDX               63 // QList<QTableWidgetSelectionRange >

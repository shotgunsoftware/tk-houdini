...
// Converter indices
#define SBK_QTSVG_QLIST_QACTIONPTR_IDX                               0 // QList<QAction * >
#define SBK_QTSVG_QLIST_QGRAPHICSITEMPTR_IDX                         1 // QList<QGraphicsItem * >
#define SBK_QTSVG_QLIST_QGRAPHICSTRANSFORMPTR_IDX                    2 // const QList<QGraphicsTransform * > &

...
#define SBK_QTHELP_QLIST_QURL_IDX                                    5 // QList<QUrl >
#define SBK_QTHELP_QLIST_QSTRINGLIST_IDX                             6 // QList<QStringList >
#define SBK_QTHELP_QPAIR_QSTRING_QSTRING_IDX                         7 // QPair<QString, QString >
#define SBK_QTHELP_QLIST_QPAIR_QSTRING_QSTRING_IDX                   8 // QList<QPair<QString, QString > >
#define SBK_QTHELP_QLIST_QHELPSEARCHQUERY_IDX                        9 // QList<QHelpSearchQuery >
#define SBK_QTHELP_QLIST_QACTIONPTR_IDX                              10 // QList<QAction * >
#define SBK_QTHELP_QLIST_QWIDGETPTR_IDX                              11 // QList<QWidget * >

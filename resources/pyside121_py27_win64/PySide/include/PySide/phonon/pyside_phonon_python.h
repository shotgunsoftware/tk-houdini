...
#define SBK_PHONON_QLIST_QACTIONPTR_IDX                              11 // QList<QAction * >
...
#define SBK_PHONON_QLIST_PHONON_AUDIOCHANNELDESCRIPTION_IDX          14 // QList<Phonon::AudioChannelDescription >
#define SBK_PHONON_QLIST_PHONON_SUBTITLEDESCRIPTION_IDX              15 // QList<Phonon::SubtitleDescription >
#define SBK_PHONON_QLIST_QVARIANT_IDX                                16 // const QList<QVariant > &
#define SBK_PHONON_QLIST_PHONON_EFFECTPARAMETER_IDX                  17 // QList<Phonon::EffectParameter >

...
// Converter indices
#define SBK_QTHELP_QLIST_QACTIONPTR_IDX                              0 // QList<QAction * >
#define SBK_QTHELP_QLIST_QWIDGETPTR_IDX                              1 // QList<QWidget * >
#define SBK_QTHELP_QLIST_QHELPSEARCHQUERY_IDX                        2 // QList<QHelpSearchQuery >
#define SBK_QTHELP_QMAP_QSTRING_QURL_IDX                             3 // const QMap<QString, QUrl > &
#define SBK_QTHELP_QLIST_QOBJECTPTR_IDX                              4 // const QList<QObject * > &
#define SBK_QTHELP_QLIST_QBYTEARRAY_IDX                              5 // QList<QByteArray >
#define SBK_QTHELP_QMAP_INT_QVARIANT_IDX                             6 // QMap<int, QVariant >
#define SBK_QTHELP_QHASH_INT_QBYTEARRAY_IDX                          7 // const QHash<int, QByteArray > &

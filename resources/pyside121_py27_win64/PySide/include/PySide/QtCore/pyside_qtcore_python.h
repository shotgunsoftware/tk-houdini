...
#define SBK_QTCORE_QLIST_QFILEINFO_IDX                               9 // QList<QFileInfo >
#define SBK_QTCORE_QLIST_QBYTEARRAY_IDX                              10 // QList<QByteArray >
#define SBK_QTCORE_QLIST_INT_IDX                                     11 // QList<int >
#define SBK_QTCORE_QLIST_QLOCALE_COUNTRY_IDX                         12 // QList<QLocale::Country >
#define SBK_QTCORE_QLIST_QLOCALE_IDX                                 13 // QList<QLocale >
#define SBK_QTCORE_QLIST_QT_DAYOFWEEK_IDX                            14 // QList<Qt::DayOfWeek >
#define SBK_QTCORE_QVECTOR_QXMLSTREAMNAMESPACEDECLARATION_IDX        15 // const QVector<QXmlStreamNamespaceDeclaration > &
#define SBK_QTCORE_QVECTOR_QXMLSTREAMENTITYDECLARATION_IDX           16 // QVector<QXmlStreamEntityDeclaration >
#define SBK_QTCORE_QVECTOR_QXMLSTREAMNOTATIONDECLARATION_IDX         17 // QVector<QXmlStreamNotationDeclaration >
#define SBK_QTCORE_QVECTOR_QXMLSTREAMATTRIBUTE_IDX                   18 // QVector<QXmlStreamAttribute > &
#define SBK_QTCORE_QLIST_QXMLSTREAMATTRIBUTE_IDX                     19 // const QList<QXmlStreamAttribute > &
#define SBK_QTCORE_QLIST_QOBJECTPTR_IDX                              20 // const QList<QObject * > &
#define SBK_QTCORE_QLIST_QURL_IDX                                    21 // const QList<QUrl > &
#define SBK_QTCORE_QPAIR_QREAL_QVARIANT_IDX                          22 // QPair<qreal, QVariant >
#define SBK_QTCORE_QVECTOR_QPAIR_QREAL_QVARIANT_IDX                  23 // QVector<QPair<qreal, QVariant > >
#define SBK_QTCORE_QMAP_INT_QVARIANT_IDX                             24 // QMap<int, QVariant >
#define SBK_QTCORE_QHASH_INT_QBYTEARRAY_IDX                          25 // const QHash<int, QByteArray > &
#define SBK_QTCORE_QPAIR_INT_INT_IDX                                 26 // QPair<int, int >
#define SBK_QTCORE_QLIST_QPAIR_INT_INT_IDX                           27 // QList<QPair<int, int > >
#define SBK_QTCORE_QLIST_QABSTRACTANIMATIONPTR_IDX                   28 // QList<QAbstractAnimation * >
#define SBK_QTCORE_QLIST_QABSTRACTSTATEPTR_IDX                       29 // const QList<QAbstractState * > &
#define SBK_QTCORE_QLIST_QABSTRACTTRANSITIONPTR_IDX                  30 // QList<QAbstractTransition * >
#define SBK_QTCORE_QSET_QABSTRACTSTATEPTR_IDX                        31 // QSet<QAbstractState * >
#define SBK_QTCORE_QLIST_QVARIANT_IDX                                32 // const QList<QVariant > &

...
with warnings.catch_warnings():
    if py3kwarning:
        warnings.filterwarnings(
            "ignore", ".*mimetools has been removed", DeprecationWarning
        )
    import mimetools
...
class HTTPResponse:
    ...
    def begin(self):
        ...
        if (
            ...
            or 100 <= status < 200
            or self._method == "HEAD"  # 1xx codes
        ):
            self.length = 0
...
try:
    ...
    class HTTPS(HTTP):
        ...
        def __init__(
            self, host="", port=None, key_file=None, cert_file=None, strict=None
        ):
    ...
    def FakeSocket(sock, sslobj):
        warnings.warn(
            "FakeSocket is deprecated, and won't be in 3.x.  "
